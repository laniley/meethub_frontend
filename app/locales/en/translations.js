export default {
  ...
  "friend": {
    ...
    "new": "This friend of yours is using Meethub now."
  },
  "meethub": {
  ...
  "participants": {
    ...
    "not_replied": "{{participant}} did not reply!"
  },
  "comment" : {
    "button" : {
      "create" : "Create",
    ...
    "no_meethub_message": "Your not in a Meethub yet, so your not able to write a comment.<br /><br />Click on the button <b>create a Meethub</b> in the right navigation."
  },
  "calendar": "Calendar",
  "comments": "Comments",
  "confirm": "Confirm",
  ...
  "not_replied": "{{name}} did not reply.",
